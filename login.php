	...
	<div class="container">
      	   ...
      	   <div class="account_grid">
			   <div class=" login-right">
			  	<h3>РЕГИСТРАЦИЯ НОВЫХ ПОЛЬЗОВАТЕЛЕЙ</h3>
				<p>Если у вас есть учетная запись на нашем сайте, пожалуйста войдите в нее</p>
    ...
    <form action="process_login.php" method="post">
        ...
        <button type="submit">Войти</button>
			    ...
			    <div class=" login-left">
			  	 <h3>Новый пользователи</h3>
				 <p>Создав учетную запись в нашем магазине, вы сможете быстро оформить заказ, получит свой товар по всем регионам СНГ, забрать заказ в нашем офиме и многое другое.</p>

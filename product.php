...
<body> 
	...
	<div class="women-product">
		<div class=" w_content">
			<div class="women">
				<a href="#"><h4>Товары - <span>3</span> </h4></a>
				<ul class="w_nav">
					<li>Сортировка : </li>
			     	<li><a class="active" href="#">Популярные</a></li> |
			     	<li><a href="#">Новые </a></li> |
			     	<li><a href="#">Скидка</a></li> |
			     	<li><a href="#">Цена: Низкая Высокая </a></li> 
			     <div class="clearfix"> </div>	
			     </ul>
			     <div class="clearfix"> </div>	
			</div>
		  ...
		  <div class="  product-grid">
			<div class="content_box"><a href="single.php">
			   	<div class="left-grid-view grid-view-left">
				    ...
				    <h4><a href="#"> Сумка PIQADRO черный кожа</a></h4>
				     <p>11999 руб
			   	</div>
              </div>
			 <div class="product-grid">
			<div class="content_box"><a href="single.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/baa.jpg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="#"> Сумка PIQADRO табачный</a></h4>
				     <p>9999 руб
			   	</div>
                 </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="single.php">
			   	<div class="left-grid-view grid-view-left">
				    ...
				    <h4><a href="#"> Сумка PIQADRO черный</a></h4>
				     <p>5999 рую
			   	</div>
                 </div>
